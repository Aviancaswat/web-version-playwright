          ...
          >
            <Box>
              ...
              <Text textAlign="left" fontSize="sm">
                Esta plataforma te permite ejecutar pruebas automatizadas de los
                principales flujos digitales de Avianca. Selecciona un
                escenario, inicia la prueba y revisa los resultados de forma
                clara y rápida.
              </Text>
      ...
      >
        ...
        <Box textAlign="center" p={4}>
          <Box
            ...
            mb={3}
          >
            <Image src={navigateIcon} alt="Reservas" width="40px" />
          </Box>
          <Heading as="h4" fontSize="lg" mb={2} color="#1b1b1b">
            Probar procesos claves
          </Heading>
          <Text fontSize="sm" color="gray.600">
            Validando flujos principales en páginas como Home, Booking,
            Services, Passengers y Payment.
          </Text>
        </Box>
        ...
        <Box textAlign="center" p={4}>
          <Box
            ...
            mb={3}
          >
            <Image src={checkIcon} alt="Errores manuales" width="40px" />
          </Box>
          <Heading as="h4" fontSize="lg" mb={2} color="#1b1b1b">
            Reducir errores manuales
          </Heading>
          <Text fontSize="sm" color="gray.600">
            Con resultados consistentes que garantizan mayor calidad y confianza
            en los procesos.
          </Text>
        </Box>
        ...
        <Box textAlign="center" p={4}>
          <Box
            ...
            mb={3}
          >
            <Image src={shareIcon} alt="Reportes claros" width="35px" />
          </Box>
          <Heading as="h4" fontSize="lg" mb={2} color="#1b1b1b">
            Compartir reportes
          </Heading>
          <Text fontSize="sm" color="gray.600">
            Claros y accesibles con tu equipo, de forma rápida y sencilla para
